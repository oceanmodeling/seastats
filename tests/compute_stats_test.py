...
def test_get_stats():
    ...
    metric99 = storm_metrics(sim, obs, quantile=0.99, cluster=72)
    metric95 = storm_metrics(sim, obs, quantile=0.95, cluster=72)
    ...
    stats["error99"] = metric99["error_norm"]
    stats["error99m"] = metric99["error"]
    stats["error95"] = metric95["error_norm"]
    stats["error95m"] = metric95["error"]
